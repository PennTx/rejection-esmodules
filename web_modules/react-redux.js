import React, { Component, useMemo, useContext, useReducer, useRef, useLayoutEffect, useEffect } from './react.js';
import reactIs, { isValidElementType, isContextConsumer } from './react-is.js';
...
_ref) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    {
      invariant_1(isValidElementType(WrappedComponent), "You must pass a component to the function returned by " + (methodName + ". Instead received " + stringifyComponent(WrappedComponent)));
    }
